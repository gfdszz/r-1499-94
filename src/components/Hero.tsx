    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          transform: isVisible ? "scale(1) translateY(0)" : "scale(1.05) translateY(20px)",
        }}
      >
      ...
      <div className="relative z-10 container mx-auto px-4 h-screen flex flex-col justify-center items-center">
        <div className={cn(
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full mb-6 shadow-lg border border-white/10 hover:bg-white/15 transition-colors">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-display text-white mb-6 leading-tight tracking-tight">
            Find Your Dream <br />
            <span className="text-gradient bg-gradient-to-r from-amber-100 via-amber-200 to-amber-300 drop-shadow-lg">
              Luxury Home
            </span>
          </h1>
          ...
          <div className="max-w-2xl mx-auto backdrop-blur-md bg-white/10 p-2 rounded-2xl border border-white/20 shadow-lg transform hover:scale-[1.01] transition-all hover:border-white/30">
            <SearchBar />
          </div>
        </div>
          ...
          <div className="flex justify-center px-4">
            <div className="grid grid-cols-3 gap-4 md:gap-8 w-full max-w-3xl">
              {[
                ...
                <div 
                  key={index} 
                  className="text-center p-4 backdrop-blur-md bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 transition-all duration-300"
                  style={{ 
                ...
                >
                  <p className="text-2xl md:text-3xl font-display text-white mb-1">{stat.value}</p>
